...
void validate_tool_runtime_settings(const ToolRuntimeSettings& settings, std::string_view context) {
    ...
    require_range(settings.workspace_snapshot_entries, 1,
                  runtime_bounds::max_workspace_snapshot_entries, "workspace_snapshot_entries",
                  context);
    require_range(settings.workspace_snapshot_bytes, 1,
                  runtime_bounds::max_workspace_snapshot_bytes, "workspace_snapshot_bytes",
                  context);
    require_range(settings.workspace_snapshot_text_bytes, 1,
...
ToolRuntimeSettings parse_tool_runtime_settings(const Json& document, std::string_view context) {
    ...
    settings.workspace_snapshot_entries =
        bounded_size(document, "workspace_snapshot_entries", settings.workspace_snapshot_entries, 1,
                     runtime_bounds::max_workspace_snapshot_entries, context);
    settings.workspace_snapshot_bytes =
        bounded_size(document, "workspace_snapshot_bytes", settings.workspace_snapshot_bytes, 1,
                     runtime_bounds::max_workspace_snapshot_bytes, context);
    settings.workspace_snapshot_text_bytes = bounded_size(
        document, "workspace_snapshot_text_bytes", settings.workspace_snapshot_text_bytes, 1,
        runtime_bounds::max_workspace_snapshot_text_bytes, context);
    ...
    validate_tool_runtime_settings(settings, context);
    return settings;
}
...
Json tool_runtime_settings_to_json(const ToolRuntimeSettings& settings) {
    Json result = {{"read_file_bytes", settings.read_file_bytes},
                   ...
                   {"workspace_snapshot_entries", settings.workspace_snapshot_entries},
                   {"workspace_snapshot_bytes", settings.workspace_snapshot_bytes},
                   {"workspace_snapshot_text_bytes", settings.workspace_snapshot_text_bytes}};
